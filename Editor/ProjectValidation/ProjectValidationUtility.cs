...
namespace UnityEditor.XR.Hands.ProjectValidation
{
    ...
    static class ProjectValidationUtility
    {
        ...
        const float k_PackageSearchTimeout = 3f;
        ...
        /// If the Samples directory does not exist, this function will do nothing and return early.
        /// </summary>
        ...
        /// <summary>
        /// Attempts to install the package with a given package version.
        /// </summary>
        /// <param name="packageName">The name of the package directory to install.</param>
        ...
        public static void TryInstallPackage(string packageName, PackageVersion targetVersion, ref AddRequest packageAddRequest)
        {
            try
            {
