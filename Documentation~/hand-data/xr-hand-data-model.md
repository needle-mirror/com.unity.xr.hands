...
A subset of the tracking data supplied by the hand API includes:

| Name | API | Description |
|:---|:---|:---|
| Hand pose | [XRHand.rootPose](xref:UnityEngine.XR.Hands.XRHand.rootPose) | The position and rotation of a hand at the wrist joint. Positions are in meters and the rotation is expressed as a quaternion. |
| Joint pose | [XRHandJoint.TryGetPose](xref:UnityEngine.XR.Hands.XRHandJoint.TryGetPose*) | The position and rotation of a joint.<br /><br />**Note**: The list of joints provided by the `XRHand` includes the fingertips and the palm, so you should interpret the term joint loosely. |
...
| Joint angular velocity | [XRHandJoint.TryGetAngularVelocity](xref:UnityEngine.XR.Hands.XRHandJoint.TryGetAngularVelocity*) | A vector expressing a joint's rotational velocity. The direction of this vector is the axis of rotation and its magnitude is the angular velocity in radians per second. |

The [`XRHand`](xref:UnityEngine.XR.Hands.XRHand) and [`XRHandJoint`](xref:UnityEngine.XR.Hands.XRHandJoint) objects are always available from a provider plug-in that supports the [`XRHandSubsystem`](xref:UnityEngine.XR.Hands.XRHandSubsystem). However, a provider might not support every possible joint on the hand. You can determine which joints the current device supports with the [`XRHandSubsystem.jointsInLayout`](xref:UnityEngine.XR.Hands.XRHandSubsystem.jointsInLayout) property. Refer to [Get provider data layout](xref:xrhands-access-data#joint-layout) for more information.
...
The data for [`XRHandDevice`](xref:UnityEngine.XR.Hands.XRHandDevice) allows you to bind to various tracked poses, such as a poke pose providing [`XRHandDevice.pokePosition`](xref:UnityEngine.XR.Hands.XRHandDevice.pokePosition) and [`XRHandDevice.pokeRotation`](xref:UnityEngine.XR.Hands.XRHandDevice.pokeRotation) at the index finger tip, and various gesture amounts like pinching.

For more information, see [XR Hand Device](xref:xrhands-hand-device) in the manual.
...
A subset of the tracking data supplied includes:

| Name | API | Description |
|:---|:---|:---|
| Device gestures, including pinch, menu pressed, and system. | [MetaAimHand.aimFlags](xref:UnityEngine.XR.Hands.MetaAimHand.aimFlags) | Hand gestures reported through the Meta Hand Tracking Aim extension to OpenXR. |
...
For more information, refer to [Meta Hand Tracking Aim OpenXR feature](xref:xrhands-meta-aim-feature).

## Joint nomenclature {#joint-nomenclature}
...
For the API declarations of the tracked points, refer to the Enum [`XRHandJointID`](xref:UnityEngine.XR.Hands.XRHandJointID) in the Unity API and [`XrHandJointEXT`](https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#XrHandJointEXT) in the OpenXR specification.
